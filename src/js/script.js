    ...
    $(window).load(function () {
        ...
        for (var category in filters) {
            ...
            for (var i = 0; i < filters[category].length; i++) {
                ...
                for (var j = 0; j < filter.segmented.length; j++) {
                    ...
                    for (var k = 0; k < segmented.labels.length; k++) {
                        $('#' + segmented.id + '-' + k).mousedown((function (filter, segmented, index) {
                            return function () {
        ...
        $('#load').click(function () {
            $('#dialog').html('<div class="contents">Pick one of the sample images below or upload an image of your own:<div class="images">' +
                '<img class="loader" src="../static/samples/mountain.jpg" height="100">' +
                '<img class="loader" src="../static/samples/smoke.jpg" height="100">' +
                '<img class="loader" src="../static/samples/face.jpg" height="100">' +
                '<img class="loader" src="../static/samples/cat.jpg" height="100">' +
                '<img class="loader" src="../static/samples/greyhound.jpg" height="100">' +
                '<img class="loader" src="../static/samples/sunset.jpg" height="100">' +
                '<img class="loader" src="../static/samples/leaf.jpg" height="100">' +
                '<img class="loader" src="../static/samples/perspective.jpg" height="100">' +
